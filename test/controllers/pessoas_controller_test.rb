...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference("Pessoa.count") do
      post pessoas_url, params: { pessoa: { bairro: @pessoa.bairro, cidade: @pessoa.cidade, email: @pessoa.email, endereco: @pessoa.endereco, nome: @pessoa.nome, telefone: @pessoa.telefone } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { bairro: @pessoa.bairro, cidade: @pessoa.cidade, email: @pessoa.email, endereco: @pessoa.endereco, nome: @pessoa.nome, telefone: @pessoa.telefone } }
